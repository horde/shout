<?php
/**
 * Defines the AJAX actions used in Shout.
 *
 ...
 * @package  Shout
 */
class Shout_Ajax_Application_Handler extends Horde_Core_Ajax_Application_Handler
{
    public function saveExtension()
    {
        try {
            ...
            $this->vars->set('account', $curaccount);
            $Form = new ExtensionDetailsForm($this->vars);
            $Form->setSubmitted();
            if ($Form->isValid()) {
                $Form->execute();
                return true;
